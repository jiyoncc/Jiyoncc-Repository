...
<head>
    ...
    <title>Categories - Sweet & Delices Cake Shop</title>
    ...
    <div class="dashboard-main-wrapper">
        ...
        ?>
            <div class="container-fluid dashboard-content">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="explore.php" class="breadcrumb-link">Explore</a></li>
                                            <?php
                                             $select = "SELECT * FROM categories WHERE category_id = ".$_GET['category'];
                                             $query = mysqli_query($con, $select);
                                             while ($res = mysqli_fetch_assoc($query)) {
                                            ?>
                                            <li class="breadcrumb-item active" aria-current="page"><?php echo $res['category_name'];?>
                                            <?php
                                            }
                                            ?>
                                        </li>
                ...
                <div class="row mx-5">
                    <?php
                    $select = "SELECT * FROM products where product_category = ".$_GET['category'];
                    $query = mysqli_query($con, $select);
                    while ($res = mysqli_fetch_assoc($query)) {
                    ?>
                        ...
                        <div class="product-thumbnail rounded">
                            ...
                            <div class="product-content">
                                <div class="product-content-head">
                                    ...
                                    <div class="product-price">Php. <?php echo $res['product_price'];?></div>
                                </div>
